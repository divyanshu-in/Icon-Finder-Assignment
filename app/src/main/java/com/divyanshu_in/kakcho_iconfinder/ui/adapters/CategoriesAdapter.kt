...
class CategoriesAdapter(private val context: Context, private val onCategoryClick: (categoryName: String, categoryIdentifier: String) -> Unit): RecyclerView.Adapter<RecyclerView.ViewHolder> (){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if(viewType == CATEGORY_VIEW){
            CategoriesViewHolder(CategoriesItemBinding.inflate(LayoutInflater.from(context), parent, false))
        }else{
            LoadingViewHolder(LoadingItemBinding.inflate(LayoutInflater.from(context), parent, false))
        }
    }
